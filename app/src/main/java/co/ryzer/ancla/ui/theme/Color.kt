 ...
 * A soft cream tone (#FAF0E6) to reduce visual fatigue and light sensitivity.
 */
val AnclaBackground = Color(0xFFFAF0E6)

/**
 * Card Component Colors (Muted Palette)
 * These tones are desaturated to avoid sensory overload.
 */
val CardGreen = Color(0xFFD4E4D8)    // Decoder Tool
